...
public final class BlackjackDialogDelegate implements CustomVisualDialogDelegate {
    private final BlackjackPanel game;
    private final Runnable onClose;
    private boolean reported;
    public BlackjackDialogDelegate(BlackjackPanel game, Runnable onClose) { this.game=game; this.onClose=onClose; }
